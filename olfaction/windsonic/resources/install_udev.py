...
rule_path = get_share_file_path_from_package(package_name="windsonic", file_name="10-windsonic.rules")
...
copyRule = Popen(f"sudo -S cp {rule_path} /etc/udev/rules.d/10-windsonic.rules".split(), stdin=PIPE, stdout=PIPE, stderr=PIPE)
