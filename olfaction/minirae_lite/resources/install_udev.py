...
rule_path = get_share_file_path_from_package(package_name="minirae_lite", file_name="10-minirae_lite.rules")
...
copyRule = Popen(f"sudo -S cp {rule_path} /etc/udev/rules.d/10-minirae_lite.rules".split(), stdin=PIPE, stdout=PIPE, stderr=PIPE)
